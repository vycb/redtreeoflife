...
, compile: function () {
    ...
    if (!this.source) {
      ...
      if (opts._with !== false) {
        prepended +=  ' with(helpers||{}){ with (' + exports.localsName + ' || {}) {' + '\n';
        appended += '  }}' + '\n';
      }
    ...
    try {
      fn = new Function(exports.localsName + ', escape, include, rethrow, helpers', src);
    }
    catch(e) {
    ...
    var returnedFn = function (data) {
      ...
      return fn.apply(opts.context, [data || {}, escape, include, rethrow, helpers]);
    };
