...
(function() {
  ...
  if (argv.help) {
    ...
    params = {
      filter:!!(_ref = argv.f)? _ref : '*',
      count: !!(_ref = argv.c)? _ref : 10000,
      numcmd:!!(_ref = argv.n)? _ref : 10000,
      db:		 !!(_ref1 = argv.d)? _ref1 : 0,
      port:	 !!(_ref2 = argv.p)? _ref2 : 6379,
      host:  !!(_ref3 = argv.h)? _ref3 : '127.0.0.1',
      format:	argv.json ? 'json' : 'redis',
      pretty:!!(_ref4 = argv.pretty) ? _ref4 : false
    };
    doDump = function() {
      return dump(params, function(err, result) {
        var _ref5;
        if (err != null) {
          return process.stderr.write("" + (!!(_ref5 = err.message)? _ref5 : err) + "\n");
        }
